  ...
  const updateRequestStatus = async (requestId, newStatus) => {
    try {
      ...
      await updateDoc(requestRef, {
        ...
        signupToken: newStatus === 'approved' ? generateToken() : null
      });
      ...
      if (newStatus === 'approved') {
        console.log('📧 SEND APPROVAL EMAIL TO:', request.email);
        console.log('Signup link:', `https://idynify.com/signup?token=${generateToken()}`);
        alert(`Approved! Send signup link to: ${request.email}\n\nLink copied to console.`);
      }
    } catch (error) {
  ...
  return (
    <div style={styles.requestCard}>
      <div style={styles.requestHeader}>
        <div>
          <h3 style={styles.requestName}>{request.name || 'No name'}</h3>
      ...
      <div style={styles.requestDetails}>
        ...
        {request.companySize && (
          <div style={styles.detailRow}>
            <span style={styles.detailLabel}>Company Size:</span>
            <span style={styles.detailValue}>{request.companySize}</span>
          </div>
        )}
        <div style={styles.detailRow}>
