      ...
      <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center p-4">
        ...
        <div className="relative z-10 max-w-2xl w-full bg-black/60 backdrop-blur-xl rounded-3xl shadow-2xl p-12 text-center border border-cyan-500/30">
          ...
          <p className="text-xl text-white/80 mb-8">
            Mission Control is reviewing your application. You'll receive clearance status within 24 hours.
          </p>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-2xl text-cyan-300 font-bold mb-2">
              Join Barry's Data Exploration Mission
            </p>
          ...
          <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-6 mb-8 backdrop-blur">
            ...
            <p className="text-white/80 leading-relaxed">
              You're applying to join an exclusive crew of early adopters exploring the future of AI-powered customer intelligence. 
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="nonprofit">Non-Profit & Social Impact</option>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex justify-center items-center gap-4 text-cyan-500/50 text-xs font-mono">
